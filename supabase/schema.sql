...
-- 中文速度成就（按 CPM 字/分，仅中文练习计入；阶梯面向打字基础薄弱的学生）
('cpm_100', '⚡', '小试牛刀', '中文速度达到 20 字/分', '中文速度成就', 'cpm', 20, false, 10),
('cpm_30',  '🌱', '渐入佳境', '中文速度达到 30 字/分', '中文速度成就', 'cpm', 30, false, 11),
('cpm_200', '🚀', '飞速前进', '中文速度达到 40 字/分', '中文速度成就', 'cpm', 40, false, 12),
('cpm_50',  '💨', '键盘快手', '中文速度达到 50 字/分', '中文速度成就', 'cpm', 50, false, 13),
('cpm_300', '🥇', '键盘飞人', '中文速度达到 65 字/分', '中文速度成就', 'cpm', 65, false, 14),
('cpm_400', '🏆', '打字大师', '中文速度达到 90 字/分', '中文速度成就', 'cpm', 90, false, 15),
('cpm_130', '👑', '键道宗师', '中文速度达到 130 字/分', '中文速度成就', 'cpm', 130, false, 16),
-- 英文速度成就（按 WPM 词/分，仅英文练习计入）
('wpm_15', '⌨️', '英文起步', '英文速度达到 15 WPM', '英文速度成就', 'wpm', 15, false, 17),
('wpm_25', '🚤', '英文快手', '英文速度达到 25 WPM', '英文速度成就', 'wpm', 25, false, 18),
('wpm_40', '✈️', '英文高手', '英文速度达到 40 WPM', '英文速度成就', 'wpm', 40, false, 19),
('acc_95',  '🎯', '精准射手', '准确率超过 92%', '准确率成就', 'accuracy', 92, false, 20),
('acc_96',  '🎖️', '神枪手', '准确率超过 96%', '准确率成就', 'accuracy', 96, false, 21),
('acc_100', '💎', '完美主义', '准确率 100%', '准确率成就', 'accuracy', 100, false, 22),
